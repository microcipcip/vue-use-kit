...
describe('useSessionStorage', () => {
  it('should get a item with the given value', async () => {
    ...
    ;(window as any).sessionStorage.setItem(itemKey, itemValue)
  ...
  it('should set a item with the given value', async () => {
    ...
    await wrapper.vm.$nextTick()
    expect(sessionStorage.getItem(itemKey)).toContain(itemValue)
  })
  ...
  it('should remove a item with the given value', async () => {
    ...
    await wrapper.vm.$nextTick()
    expect(sessionStorage.getItem(itemKey)).toBeFalsy()
  })
